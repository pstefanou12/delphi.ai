...
class TruncatedLinearRegression(stats):
    ...
    def fit(self, X: Tensor, y: Tensor):
        ...
        if config.args.var: # known variance
            ...
            # assign empirical estimates
            self.lambda_ = self.emp_var.inverse()
            self._lin_reg.layer.weight.data, self._lin_reg.layer.bias.data = self.emp_weight * self.lambda_, self.emp_bias * self.lambda_
