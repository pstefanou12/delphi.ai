...
class TestDistributions(unittest.TestCase): 
    ...
    def test_unknown_normal_truncation_oracle(self):
        M = MultivariateNormal(ch.zeros(1), ch.eye(1)) 
        samples = M.rsample([10000,])
    ...
    def test_unknown_truncation_normal_known_variance(self):
        # generate ground-truth data
        M = MultivariateNormal(ch.zeros(1), ch.eye(1)) 
        samples = M.rsample([1000,])
        phi = oracle.Right_Distribution(Tensor([0.0]))
    ...
    def plot_gradient_contours_mu(self):
    ...
    def plot_gradient_contours_var(self):
        """Plot loss contours and gradients around the true parameters"""
        import matplotlib.pyplot as plt
        import numpy as np
        from delphi.distributions.unknown_truncated_multivariate_normal import Exp_h
    ...
    def debug_exponential_dependence(self):
    ...
    def debug_exponential_dependence_var(self):
    ...
    def debug_loss_component_scales(self):
    ...
    def debug_variance_dependence(self):
    ...
    def debug_variance_dependence_two(self):
